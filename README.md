...
|---------|-------|----------------|
| ROC-AUC | 0.8981 | Excelente capacidad discriminativa |
...
|---------|---------------|----------------------------|
| Cluster 0 | 52.3% | Perfil balanceado |
...
4. 🎯 **Habilidades digitales** - Competencias clave
5. 💰 **Ingresos familiares** - Contexto socioeconómico
